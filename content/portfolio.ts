...
export const transientSpaceProject = {
  ...
  medium: "Watercolor on paper",
  description:
    "A series of twenty watercolours on paper exploring temporary architectures, looping botanical lines and shifting geometric enclosures. Green, blue and luminous yellow spaces hover between interior, landscape and remembered place.",
